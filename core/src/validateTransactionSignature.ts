...
/**
 * Thrown when a transaction doesn't contain a valid StreamPay transfer.
 */
...
/**
 * Validate that a given transaction signature corresponds with a transaction containing a valid StreamPay transfer.
 *
