...
/**
 * Create a StreamPay transaction.
 *
...
export async function createTransaction(
    ...
    // A native SOL, USDC or Stream SPL token transfer instruction
    let instruction: TransactionInstruction;

    // If no USDC, Stream SPL token mint is provided, transfer native SOL
    if (!splToken) {
